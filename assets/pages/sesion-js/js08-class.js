...
function createListItemsOfProducts(products) {
   ...
   const productsLifeSpan = products.map(
      (product) => `<li> ${product.name} se creó hace ${product.lifeSpan() / 1000} s. </li>`
   );
...
function onClickLifeSpan() {
   ...
   setTimeout(() => {
      // crea retardo de 5 ms para ver la diferencia de tiempo.
